...
async function getHome(cb) {
    const cats = {"أفلام": "/category/movies/", "مسلسلات": "/category/series/", "أنمي": "/category/anime/"};
    const data = {};
        ...
        try {
            ...
            if (articles.length === 0) {
                ...
                for (const post of posts) {
                    ...
                    const isSeries = href.includes('مسلسل') || href.includes('series') || href.includes('anime') || true;
